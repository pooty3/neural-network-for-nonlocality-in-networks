...
def run_model(img_path):
    ...
    #model = build_model2()
        ...
        model.fit(generate_xy_batch(w), steps_per_epoch=50, epochs=100, verbose=1, validation_data=generate_xy_batch(w), validation_steps=5, class_weight=None, max_queue_size=10, workers=1, use_multiprocessing=False, shuffle=False, initial_epoch=0)
