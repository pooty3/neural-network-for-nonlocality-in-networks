...
class Config:
    ...
    def __init__(self):
        ...
        self.target_distr_name = "CGLMP" # check targets.py for possible names
        ...
        self.a_outputsize = 3 # Number of outputs for Alice
        self.b_outputsize = 3 # Number of outputs for Bob
